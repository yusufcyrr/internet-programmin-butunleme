		...
		<div class="container">
			<div class="row">
				<div class="col-md-9">
					...
					<div class="f-credit">&copy; <?php echo $ayarcek['ayar_author']  ?> <a href="
                    http://222.yusufcayir.com">www.yusufcayir.com</a></div>
				...
				<div class="col-md-3"><!--footer Share-->
					...
					<div class="fsoc">
						...
						<a href=<?php echo $ayarcek['ayar_youtube']; ?> class="fflickr">Youtube</a>
						<a href=<?php echo $ayarcek['ayar_google']; ?> class="ffeed">Google</a>
						<div class="clearfix"></div>
					</div>
					<div class="clearfix"></div>
				</div><!--footer Share-->
